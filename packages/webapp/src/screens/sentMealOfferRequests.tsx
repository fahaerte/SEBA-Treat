...
export const SentMealOfferRequests = () => {
    ...
    const [sentMealOfferRequests, setSentMealOfferRequests] = useState([] as MealOffer[])
                    ...
                    <MealOfferRequest mealOffer={mealOffer}>
                        {
                            mealOffer.reservations.map((reservation, index) => {
                                return <SentMealReservation key={index} mealOfferId={mealOffer._id}
                                                            sellerId={mealOffer.user} reservation={reservation}/>
                            })
                        }
                    </MealOfferRequest>
                    <hr/>
