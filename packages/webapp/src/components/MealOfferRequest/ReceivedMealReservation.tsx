...
export const ReceivedMealReservation = ({mealOfferId, reservation}: ReceivedMealReservationProps) => {
    ...
    function getActionBar() {
        if (reservationState == MealReservationState.BUYER_REJECTED ||
            ...
            return (
                <Row>
                    <Col className={"col-sm-auto"}>
                        <Button onClick={() => updateReservationState(MealReservationState.SELLER_REJECTED)}>Decline
                            offer</Button>
                    </Col>
                    <Col className={"col-sm-auto"}>
                        {getActionButton()}
