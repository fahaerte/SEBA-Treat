...
import { SCInput, SCFloatingFormSearch } from "../styles";
...
const InputControlledSearch = ({
  ...
  return (
    <SCFloatingFormSearch className={["form-floating"].join(" ")}>
      <SCInput
        value={value}
        disabled={disabled}
        id={inputId}
    ...
    </SCFloatingFormSearch>
  );
};

export default InputControlledSearch;
