...
class MealReservationService {
    ...
    public async create(
        ...
        const mealOffer = await this.MealOfferService.getMealOffer(mealOfferId) as MealOffer;
    ...
    public async getMealReservation(
        ...
        const mealReservation = await this.mealReservation.findById(mealReservationId) as MealReservation;
    ...
    public async setMealReservationStateToSellerAccepted(
        ...
        return await this.setMealReservationStatus(mealReservationId, user,
            MealReservationState.PENDING, MealReservationState.SELLER_ACCEPTED);
    }
    ...
    public async setMealReservationStateToSellerRejected(
        ...
        return await this.setMealReservationStatus(mealReservationId, user,
            MealReservationState.PENDING, MealReservationState.SELLER_REJECTED);
    }
    ...
    public async setMealReservationStateToBuyerConfirmed(
        ...
        return await this.setMealReservationStatus(mealReservationId, user,
            MealReservationState.SELLER_ACCEPTED, MealReservationState.BUYER_CONFIRMED);
    }
    ...
    public async setMealReservationStateToBuyerRejected(
        ...
        return await this.setMealReservationStatus(mealReservationId, user,
            MealReservationState.SELLER_ACCEPTED, MealReservationState.BUYER_REJECTED);
    }
    ...
    private async setMealReservationStatus(
        ...
        const mealReservation = await this.getMealReservation(mealReservationId, user) as MealReservation;
    ...
    private checkIfUserIsAllowedToGetReservation(
        ...
        user: User): boolean {
        return (String(user._id) === String(mealReservation.buyer) ||
