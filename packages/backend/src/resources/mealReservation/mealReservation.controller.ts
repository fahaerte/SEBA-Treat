...
class MealReservationController implements Controller {
  ...
  private create = async (
    ...
    try {
      ...
      const newMealReservation = await this.MealReservationService.create(
        mealOfferId,
        req.user
      );
  ...
  private getMealReservation = async (
    ...
    try {
      ...
      const mealReservation =
        await this.MealReservationService.getMealReservation(
          mealReservationId,
          req.user
        );
  ...
  private setMealReservationStateToSellerAccepted = async (
    ...
    try {
      const mealReservationId = req.params.mealReservationId;
      const mealReservation =
        await this.MealReservationService.setMealReservationStateToSellerAccepted(
          mealReservationId,
          req.user
        );
      res.status(200).send({ data: mealReservation });
  ...
  private setMealReservationStateToSellerRejected = async (
    ...
    try {
      const mealReservationId = req.params.mealReservationId;
      const mealReservation =
        await this.MealReservationService.setMealReservationStateToSellerRejected(
          mealReservationId,
          req.user
        );
      res.status(200).send({ data: mealReservation });
  ...
  private setMealReservationStateToBuyerConfirmed = async (
    ...
    try {
      const mealReservationId = req.params.mealReservationId;
      const mealReservation =
        await this.MealReservationService.setMealReservationStateToBuyerConfirmed(
          mealReservationId,
          req.user
        );
      res.status(200).send({ data: mealReservation });
  ...
  private setMealReservationStateToBuyerRejected = async (
    ...
    try {
      const mealReservationId = req.params.mealReservationId;
      const mealReservation =
        await this.MealReservationService.setMealReservationStateToBuyerRejected(
          mealReservationId,
          req.user
        );
      res.status(200).send({ data: mealReservation });
