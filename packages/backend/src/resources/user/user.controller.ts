...
class UserController implements Controller {
    ...
    private login = async (
        ...
        try {
            ...
            const token = await this.UserService.login(email as string, password as string);
    ...
    private getProfilePicture = (
        ...
        try {
            ...
            if (!req.params.userid) {
                profilePicturePath = this.UserService.getProfilePicturePath(req.user._id);
            } else {
                profilePicturePath = this.UserService.getProfilePicturePath(req.params.userid);
            }
